...
for duck in range(20):
	duck_postion_x = random.randrange(50,1200)
	duck_postion_y = random.randrange(120 ,600)
	duck_rect = duck_surface.get_rect(center = (duck_postion_x, duck_postion_y))
...
while True:
	...
	screen.blit(cloud1,(60,60))
	screen.blit(cloud2,(450,40))
	screen.blit(cloud1,(750,80))
	screen.blit(cloud2,(1000,100))
	screen.blit(cloud1,(150,20))
